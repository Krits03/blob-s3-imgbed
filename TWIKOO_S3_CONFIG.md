...
| 上传返回 413 | 请求体超过平台限制 | Vercel Serverless Function 约 4.5MB；Twikoo 限制图片 10MB |

---

## 参考

- 项目简介与接口说明：[`README.md`](./README.md)
- 部署步骤（创建 Blob Store / 配置环境变量 / 验证）：[`DEPLOY.md`](./DEPLOY.md)
